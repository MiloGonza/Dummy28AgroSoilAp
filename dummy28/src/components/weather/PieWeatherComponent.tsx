    ...
    datasets: [
      {
        ...
        backgroundColor: ['rgba(15, 59, 86, 0.7)', 'rgba(21, 101, 192, 0.7)', 'rgba(51, 86, 50, 0.7)', 'rgba(255, 112, 67, 0.7)'],
        borderColor: ['rgba(15, 59, 86, 1)', 'rgba(21, 101, 192, 1)', 'rgba(51, 86, 50, 1)', 'rgba(255, 112, 67, 1)'],
        borderWidth: 1
      }
    ]
  };
