    ...
    <Box sx={{ flexGrow: 1, p: 2 }}>
      ...
      <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 12, sm: 12, md: 12 }}>
        {showMenu && (
          <Grid size={6}>
            <Box sx={{ bgcolor: 'primary.main', color: 'primary.contrastText', p: 2, textAlign: 'center' }}>
              menu informativo
              <Grid size={12}>
                <Box sx={{ bgcolor: 'white', color: 'primary.contrastText', p: 2, textAlign: 'center' }}>
                  Graficos
                ...
                <Box sx={{ bgcolor: 'secondary.main', color: 'white', p: 2, textAlign: 'center' }}>Datos</Box>
              </Grid>
            </Box>
          </Grid>
        )}
        ...
        <Grid size={showMenu ? 6 : 12}>
          <Box sx={{ bgcolor: 'secondary.main', color: 'secondary.contrastText', p: 2, textAlign: 'center' }}>
            Mapa
            <RasterMap />
          </Box>
        </Grid>
